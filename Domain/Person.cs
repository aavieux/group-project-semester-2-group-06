...
namespace Domain
{
    public class Person
    {
        ...
        public Person(UserRole roleType,string firstName, string lastName, DateTime birthDate, string address, string phoneNumber, decimal salary, string email, string nickname, string password, EmployeeRole employeeRole, Department department)
        {
            this.firstName = firstName;
            this.lastName = lastName;
            this.birthDate = birthDate;
