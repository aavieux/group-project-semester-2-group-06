namespace Project_Media_Bazaar
{
	partial class EmployeeDashboard
	{
		...
		private void InitializeComponent()
		{
			...
			label14.Location = new Point(104, 191);
			...
			label13.Location = new Point(104, 156);
			...
			label12.Location = new Point(104, 119);
			...
			label11.Location = new Point(104, 77);
			...
			// dtDateShift
			// 
			dtDateShift.Location = new Point(256, 191);
			dtDateShift.Margin = new Padding(3, 2, 3, 2);
			dtDateShift.Name = "dtDateShift";
			dtDateShift.Size = new Size(220, 23);
			dtDateShift.TabIndex = 5;
			// 
			// cbShifts
			// 
			cbShifts.FormattingEnabled = true;
			cbShifts.Location = new Point(256, 154);
			cbShifts.Margin = new Padding(3, 2, 3, 2);
			cbShifts.Name = "cbShifts";
			cbShifts.Size = new Size(133, 23);
			cbShifts.TabIndex = 4;
			// 
			// tbphoneShift
			// 
			tbphoneShift.Location = new Point(256, 119);
			tbphoneShift.Margin = new Padding(3, 2, 3, 2);
			tbphoneShift.Name = "tbphoneShift";
			tbphoneShift.Size = new Size(110, 23);
			tbphoneShift.TabIndex = 3;
			// 
			// tbNameEmShift
			// 
			tbNameEmShift.Location = new Point(256, 77);
			tbNameEmShift.Margin = new Padding(3, 2, 3, 2);
			tbNameEmShift.Name = "tbNameEmShift";
			tbNameEmShift.Size = new Size(110, 23);
			tbNameEmShift.TabIndex = 2;
			// 
			// btnSelectEmployeeToShift
			// 
			btnSelectEmployeeToShift.Location = new Point(256, 29);
			btnSelectEmployeeToShift.Margin = new Padding(3, 2, 3, 2);
			btnSelectEmployeeToShift.Name = "btnSelectEmployeeToShift";
			btnSelectEmployeeToShift.Size = new Size(83, 22);
			...
			cbEmployeesShifts.Location = new Point(99, 29);
