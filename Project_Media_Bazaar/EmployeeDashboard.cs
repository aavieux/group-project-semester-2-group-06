    ...
    public partial class EmployeeDashboard : Form
    {
        ...
        private void btnCreate_Click_1(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrWhiteSpace(tbemail.Text) &&
                ...
                cbRole.SelectedItem is EmployeeRole &&
                cbDepartment.SelectedItem != null)
            {
                try
                {
                    ...
                    Employee employee = new Employee(email, workingHours, role, firstName, lastName, dateTime, address, phoneNumber, salary, nickname, password, employeeRole, department);
